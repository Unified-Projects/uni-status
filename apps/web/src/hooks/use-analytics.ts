...
export function useDashboardAnalytics(options?: {
  ...
  return useQuery({
    ...
    queryFn: () =>
      apiClient.analytics.dashboard(organizationId ?? undefined, {
        includeTrend,
      }),
...
export function useUptimeAnalytics(params?: {
  monitorId?: string;
  days?: number;
  ...
  return useQuery({
    ...
    queryFn: () =>
      apiClient.analytics.uptime(params, organizationId ?? undefined),
    enabled: !!organizationId,
  });
}
...
export function useResponseTimeAnalytics(monitorId: string, hours?: number) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      apiClient.analytics.responseTimes(
        monitorId,
        hours,
